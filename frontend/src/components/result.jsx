...
export default function Result() {
  ...
  return (
    <motion.div id="result"
      className="w-full min-h-min mb-8 md:h-screen"
      ...
      >
       ...
       <div className="bg-red-400 w-full h-2/3 md:w-[80%] md:h-[80%] bg-contain mx-auto relative  ">
         ...
         <Button type="button" content="<" className="absolute text-5xl font-semibold left-[35%] -bottom-10 hover:shadow-lg hover:shadow-blue-500 " onClick={()=>setIndex(index-1)} />
         <Button type="button" content=">" className="absolute text-5xl font-semibold right-[35%] -bottom-10 hover:shadow-lg hover:shadow-blue-500" onClick={()=>setIndex(index+1)} />
         {/* <img src={url} alt="result" className="w-full h-full" loading="lazy"></img>
